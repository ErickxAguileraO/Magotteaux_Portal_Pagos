   ...
   <div class="card mb-3">
      <div class="card-body">
         <div class="row">
            ...
            <div class="mb-3 mb-md-0 col-md-7">
                @if (!isset($logCarga))
                <h6 class="mb-0">Última carga masiva: No hay cargas masivas</h1>
                @else
                <h6 class="mb-0">Última carga masiva: {{$logCarga->created_at->format('d-m-Y / H:i')}} | Planta: {{$pago->planta->pla_nombre}}</h1>
                @endif
             </div>
