...
<div class="row">
  <div class="mb-3 mb-md-0 col-md-3 col-lg-2">
    <div class="card">
      <div class="card-body">
        <ul class="menu">
          <li><a href="/maqueta/usuario/"><i class="fa-regular fa-user fa-fw"></i> Usuarios</a></li>
          <li class="active"><a href="/maqueta/proveedor/"><i class="fa-light fa-user-group fa-fw"></i> Proveedores</a></li>
        </ul>
      </div>
    </div>
  </div>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-sm-5 text-end">
            <div class="pl" style="display:inline-block;"> <a class="btn btn-success text-nowrap" style="width: 100%;" href="/maqueta/proveedor/crear/">Crear nuevo proveedor <i class="fa-light fa-circle-plus fa-fw"></i></a> </div>
          </div>
        </div>
      </div>
    </div>
