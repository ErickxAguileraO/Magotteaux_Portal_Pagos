  ...
  <div class="card-body">
    <div class="mb-4 row">
      <div class="mb-3 mb-lg-0 col-lg-6 align-self-center">
        <h1 class="mb-0">Consulta visualización de pagos - Proveedor 1</h1>
      </div>
      <div class="col-lg-6">
      ...
      <table class="table table-borderless" style="min-width: 650px;" cellspacing="0" cellpadding="0" border="0">
        ...
        <tbody>
          <tr>
            ...
            <td>Pendiente</td>
            <td>Dato 1.8</td>
            <td class="text-center"><a href="/public/maqueta/pagos/detalle2/"><img src="/public/imagenes/sitio/i-ojo.svg" alt="Ver" width="14" height="16" /></a></td>
          </tr>
          <tr>
            <td>6</td>
            <td>76.123.456-7</td>
